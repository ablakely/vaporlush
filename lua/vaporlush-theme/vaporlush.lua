    ...
    if (activate == true) then
        scheme = {
            ...
            Secondary = {
                ...
                shade2 = hsl(237, 25, 40),
                shade3 = hsl(329, 100, 45),
            },
            Tertiary = {
...
return lush(function(injected_functions)
      ...
      return {
          CursorLine   { bg = "none"                                                            },      
          Directory    { bg = "none",       fg = VaporLush.Quintary.shade1,     gui = underline },      
          ...
          EndOfBuffer  {  bg = "none",      fg = VaporLush.Secondary.shade0,    gui=italic      },      
          VertSplit    {  bg = "none",      fg = VaporLush.Secondary.shade0                     },      -- Column separating vertically split windows
          Folded       { bg = "none",       fg = VaporLush.Secondary.shade2                     },      -- Line used for closed folds
          ...
          LineNr       { bg = "none",       fg = VaporLush.Secondary.shade3                     },      
          CursorLineNr {  bg = VaporLush.Primary.shade1,      fg = VaporLush.Quintary.shade1                      },      
          Normal       { bg = "none",       fg = VaporLush.Secondary.shade3                     },      -- Normal text
          Pmenu        { SignColumn                                                                                   },      -- Popup menu: Normal item.
          PmenuSel     { bg = "none",       fg = VaporLush.Tertiary.shade3                      },      -- Popup menu: Selected item.
          ...
          Comment      { bg = "none",       fg = VaporLush.Secondary.shade3,     gui=italic      },      -- Any comment
          ...
          Statement      { bg = "none",     fg = VaporLush.Primary.shade1,      gui=""          },      -- (*) Any statement
          Conditional    { Statement                                                                              },      --   if, then, else, endif, switch, etc.
          Repeat         { Statement,                                                             gui=italic      },      --   for, do, while, etc.
          Label          { bg="none",       fg=VaporLush.Primary.shade2      },      --   case, default, etc.
